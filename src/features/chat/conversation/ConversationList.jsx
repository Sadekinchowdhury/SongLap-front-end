  ...
  return (
    <div>
      ...
      <div className="flex justify-between py-4 items-center cursor-pointer">
        ...
        <div>
          <h6 className="text-[14px] font-bold text-[var(--text-color)] leading-[14px] mb-1.5">Sadekin Chowdhury</h6>
          <p className="text-[13px] font-medium text-[var(--text-color)] leading-[12px]">Hi this is sadekin chow</p>
        </div>
        <div>
          <h6 className="text-[12px] font-semibold text-[var(--text-color)] leading-[14px] mb-1.5 text-end">02/04/2025</h6>
